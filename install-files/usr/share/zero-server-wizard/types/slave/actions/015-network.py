...
def check_variables():
	...
	lst=["external_iface","internal_iface","srv_ip","internal_mask","external_mask","external_ip","external_gateway","external_mode","number_classroom","replication_iface"]
	for item in lst:
...
if ret[0]:
	...
	try:
		...
		print c.set_replication_interface(user,'NetworkManager',replication_iface,'10.3.0.' + str(int(number_classroom)) ,'255.255.255.0',True )
